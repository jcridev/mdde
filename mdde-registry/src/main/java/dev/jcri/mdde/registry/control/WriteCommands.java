...
public enum WriteCommands {
     ...
     */
    WriteCommands(final String command, final List<ExpectedCommandArgument> args) {
    ...
    private static Map<String, WriteCommands> _commandsMap = Arrays.stream(WriteCommands.values())
     ...
     */
    public static WriteCommands getCommandTag(String tag) throws UnknownRegistryCommandExceptions {
