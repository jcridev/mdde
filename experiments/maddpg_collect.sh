...
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_dn_g05${POSTFX} ${WORK_DIR}/res_maddpg/maddpg_dn_g05${POSTFX})

# Without do-nothing
mkdir -p ${WORK_DIR}/res_maddpg/maddpg_wdn_g05${POSTFX}
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_g05${POSTFX} ${WORK_DIR}/res_maddpg/maddpg_wdn_g05${POSTFX})