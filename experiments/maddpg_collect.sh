...
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_dn_sm0 ${WORK_DIR}/res_maddpg/maddpg_dn_sm0)

# Without do-nothing, disregard storage
mkdir -p ${WORK_DIR}/res_maddpg/maddpg_wdn_sm0
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_sm0 ${WORK_DIR}/res_maddpg/maddpg_wdn_sm0)

# With do-nothing, disregard storage
mkdir -p ${WORK_DIR}/res_maddpg/maddpg_dn_sm0_b1
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_dn_sm0_b1 ${WORK_DIR}/res_maddpg/maddpg_dn_sm0_b1)
...
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_dn_b1_e10k_s100 ${WORK_DIR}/res_maddpg/maddpg_dn_b1_e10k_s100)
...
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_scale ${WORK_DIR}/res_maddpg/maddpg_wdn_scale)


mkdir -p ${WORK_DIR}/res_maddpg/maddpg_wdn_dm940
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_dm940 ${WORK_DIR}/res_maddpg/maddpg_wdn_dm940)

mkdir -p ${WORK_DIR}/res_maddpg/maddpg_wdn_dm480
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_dm480 ${WORK_DIR}/res_maddpg/maddpg_wdn_dm480)

mkdir -p ${WORK_DIR}/res_maddpg/maddpg_wdn_long_learn
(cd ${COMPOSE_DIR}/scripts/ && sh maddpg_retrieve_results.sh ${PFX}maddpg_wdn_long_learn ${WORK_DIR}/res_maddpg/maddpg_wdn_long_learn)
